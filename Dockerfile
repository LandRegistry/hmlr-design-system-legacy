...
# Install nodejs
RUN cd /supporting-files && curl -SLO "https://nodejs.org/dist/v12.18.2/node-v12.18.2-linux-x64.tar.xz" && \
tar -xJf "node-v12.18.2-linux-x64.tar.xz" -C /usr/local --strip-components=1 && \

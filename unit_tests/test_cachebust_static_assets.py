...
from demo.custom_extensions.cachebust_static_assets.main import (
    CachebustStaticAssets, md5_for_file)
...
class TestCachebustStaticAssets(unittest.TestCase):
    ...
    @mock.patch('demo.custom_extensions.cachebust_static_assets.main.md5_for_file', wraps=md5_for_file)
